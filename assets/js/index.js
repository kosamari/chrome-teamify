$(function() {
  const PARENT_FACE_X = '322px'; // Distance of face hole from left. Gross.
  const PARENT_FACE_Y = '218px' // Distance of face hole from top. Gross.
  const PARENT_FACE_HEIGHT = '118px' // The height of the face hole. Gross.
  const PARENT_FACE_WIDTH = 79; // The width of the face hole. Gross.
